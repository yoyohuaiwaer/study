                        ...
                        $.each(key.qhMenu2,function(l,val){
                            ...
                            if(val.qhMenu2.id == '58661d345a5a9763823e639c'){
                                ...
                                $.each(val.qhMenu3,function(x,text){
                                    ...
                                    xl += '<li class="node neck" id="'+text.id+'"> <div class="node-font"> <span class="node-icon icon-file"></span> <div class="node-name" data-id="'+text.id+'"><a href="javascript:void(0);" title="'+menuUrl+''+text.url+'">'+text.name+'</a></div> </div> </li>';

                                })
                                dom +='<li class="node" id="'+val.qhMenu2.id+'"> <div class="node-font"> <span class="node-icon icon-file icon-chevron-left"></span> <div class="node-name toggle" data-id="'+val.qhMenu2.id+'" ><a href="javascript:void(0);" title="'+menuUrl+''+val.qhMenu2.url+'">'+val.qhMenu2.name+'</a></div> </div><ul class="tree-menus tree-menu3 hide">'+xl+'</ul> </li>';
                            }else {
