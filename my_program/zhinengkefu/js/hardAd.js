$(document).ready(function(){
            ...
            success:function(data){
                ...
                if(data.code == '1'){
                    $.each(data.data.datas,function(i,key){
                        ...
                        '<div class="endTime"  style="width:100px;max-width:100px">'+ state+'</div> ' +
	...
	function newPage(){
	    $.get('hardAd.html',{token:$.cookie("token")},function(response){
