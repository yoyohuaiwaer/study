    ...
    InitDate.prototype = {
        ...
        events:function(that, opts, self, arrTime) {
            ...
            jeDt.on(QD(Cell + " .jedatebot .jedateok")[0], "click", function(ev) {
                ...
                if (!isformat) {
                    var nowTime = [ newDate.getFullYear(), newDate.getMonth() + 1, newDate.getDate(), newDate.getHours(), newDate.getMinutes(), newDate.getSeconds() ];
...
//                  var okVal = jeDt.val(self) != "" || jeDt.text(self) != "" ? jeDt.parse([ okTime[0], okTime[1], okTime[2] ], [ okTimeArr[0], okTimeArr[1], okTimeArr[2] ], opts.format) :"";
                    var okVal = jeDt.val(self) != "" || jeDt.text(self) != "" ? jeDt.parse([ okTime[0], okTime[1], okTime[2] ], [ okTimeArr[0], okTimeArr[1], okTimeArr[2] ], opts.format) :jeDt.parse([ newDate.getFullYear(), newDate.getMonth() + 1, newDate.getDate() ], [ newDate.getHours(), newDate.getMinutes(), newDate.getSeconds() ], opts.format) ;
