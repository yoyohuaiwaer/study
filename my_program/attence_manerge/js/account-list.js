                ...
                if(response.data.datas == ''){
                    ...
                    $.each(response.data.datas,function(i,key){
                        ...
                        html += '<div class="grid-body-tr"> ' +
                            ...
                            '<div class=""><span title="">'+key.email+'</span></div>' +
                            '<div class=""><span title="">'+key.nick+'</span></div>'
                                if(key.industry == undefined){
                                    html += '<div class=""><span title="">无</span></div>' ;
                                }else {
                                    html += '<div class=""><span title="">'+key.industry+'</span></div>' ;
                                }
                            html += '<div class="operation"> <span> <a class="edit" rel="0" id="'+key.id+'">修改</a> <a class="showOverflow" rel="'+key.id+'">删除</a> </span> </div> </div>';
                    })
                   ;
                    //分页判断
