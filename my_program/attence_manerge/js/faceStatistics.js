...
function pullModel(start_Time,end_Time,page){
    ...
    $.ajax({
        url:commUrl+'/member/attendanceStatDetail',
        //type:'POST',
        cache:false,
        data:obj,
        dataType:'json',
        success:function(data){
            ...
            var html =  '<tr class="grid-head-th">'+
                ...
                '<th class="perc" style="width: 152px; ">所属商家</th>'+
                ...
                if(data.data.survey.length == 0){
                    ...
                    $.each(data.data.survey,function(i,key){
                        ...
                        html += '<tr class="grid-body-tr" > ' +//<td class="start_Time"  style="width:200px">'+key.date+'</td>
                            '<td class="totalNum"  style="width:152px;"><span data-id="">'+key.key+'</span></td> ' ;
                        if(key.parendBusiness == ''){
                           ...
                           html += '<td class="successNum"  style="width:152px;">'+key.totalCount+'</td> ' +
