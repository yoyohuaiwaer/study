        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.code == 1) {
                    ...
                    $('#lianxiren').attr({value:data.data.contacts});
                    $('#telephone').attr({value:data.data.phone});
                    $('#number').attr({value:data.data.terminalNumber});
                    $('input[name="status"]').each(function(){
                    if($(this).attr('value') == data.data.state){
                        $(this).prop( "checked", true);
	                    }
	                })
                    $('input[name="apptype"]').each(function(){
                    if($(this).attr('value') == data.data.appType){
                        $(this).prop( "checked", true);
	                    }
	                })
       ...
       if($.cookie('accountCode') == 1) {
           $.ajax({
               ...
               data:{
                   ...
                   nick:$('#nick').val(),
                   contacts:$('#lianxiren').val(),
                   phone:$('#telephone').val(),
                   terminalNumber:$('#number').val(),
                   state:status,
                   appType:apptype,
                   sceneStr:details,
