$(document).ready(function(){
	$(".breadcrumb").empty();
	var breadcrumb = '<li class="selected"><a class="" alt="hotAnswerStatistics.html" id="5850c53cb2a99afa74c513bc">热门答案统计</a></li>';
        ...
        success:function(data){
            ...
            if(data.code == '1'){
                $.each(data.data,function(i,key){
                    ...
                    html += '<div class="grid-body-tr"> <div class="answer"  style="width:600px; max-width:600px">'+key.answers+'</div> ' +
                    '<div class="num"  style="width:160px;">'+key.total+'</div> ' +
                    '<div class="percent"  style="width:200px;">'+perc+'%</div> </div>'
                })
            }
        	$(".grid-body").html(html);
        },
